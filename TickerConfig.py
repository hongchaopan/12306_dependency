...
# 以下是我从我的浏览器里看到的信息，你可以去网上找一找怎么从你的浏览器里找到12306的cookies (header-cookies)
# 找到下面两个变量的数值
RAIL_EXPIRATION = "1577568770967"
RAIL_DEVICEID = "Vq9XdnR3Gpxt21i189fDl7SxlaK3I-b9e_eLvOCHxApNH2rIyjP4FqvG1MdfQqoCkqYQFvczpdD_g6QaHs5ZF8RXHoFzjZcK1lcyy5sioLz9eMovkHDvR7BZ1uym3aX29lc7Mxm_0D8IuIYvPEYtDwtymLVaNfmh"
